...
print_modname() {
  ui_print "*****************************************"
  ui_print "Riru - Enhanced mode for Storage Redirect"
  ui_print "*****************************************"
}
...
check_app_version() {
  ...
  [[ "$VERSION" -ge 219 ]] || abort "! Please upgrade Storage Redirect app to v1.8.2 or above, you can find download from https://sr.rikka.app"
}
